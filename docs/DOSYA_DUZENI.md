...
| Not Kutusu ekranı, aşamalı geçmiş, paylaşım düzenleme, tepkiler ve zararlı dosya incelemesi | `src/scripts/not-kutusu.js`, `worker/worker.js`, `migrations/008_soru_emoji_tepkileri.sql`, `migrations/010_admin_istatistik_ve_not_kutusu_genisletme.sql`, `migrations/011_zararli_dosya_karantinasi.sql`, `migrations/014_soru_duzenleme_ve_siralama.sql` |
